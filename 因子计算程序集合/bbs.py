...
def calculate_factor(df,window_1):
    ...
    def read_free_turn_rate(code):
        path=r'D:\量化交易构建\市场数据库\数据库\申万二级行业自由流通换手率'
    ...
    combined_df['factor'] = combined_df['std'] / combined_df['mean_free_turn']

    return combined_df

# 计算所有股票的因子
def calculate_all_factors(price_path,window_1=20):
    # 获取所有股票代码
