...
def calculate_factor(df, window_1=2, window_2=5):
    ...
    # 计算价格1天的变化量
    df['price_delta'] = df['close'].diff(1)
...
def main():
    ...
    factor=fig[["factor"]].plot.hist(bins=50)

    standard_factor=fig[["standard_factor"]].plot.hist(bins=50)
